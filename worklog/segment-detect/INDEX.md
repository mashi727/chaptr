...
- [[2026-09-12]] — 実素材で休憩判別が崩壊（134分に休憩12個を捏造）していたのを発見し、「静穏」から「非コヒーレンス」へ定義を作り直して偽陽性ゼロに。感度プリセット4段（既定=拾い）、区間スペクトログラムのワーカースレッド化、チャプター時刻の編集、字幕からの表題下書き。`37bdaf3` / `23a1ca4` / `9d241ce` / `402fa48`
